...
On the 23rd of March 2025 23andMe filed for bankruptcy. On the 24th of March 2025 I decided to download as much of my own data as possible, and then withdraw my data from the company completely. When I initially sent my sample off in 2015, I was curious to know all the things I could know based on my *personal genotype* and, crucially, I didn't have the tools to do the analysis myself. Fast forward 10 years, and I have the skill to sequence my own genome if I wanted to (I don't have the resources, sadly) and, more importantly, I have the ability to manipulate genomic data.
...
In this repo you will find a bash script containing a function that will convert the 23andme .txt output to a .vcf file for downstream applications. It has 3 associated flags:  
